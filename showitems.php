           ...
           <?php
            ...
            {   echo " <table id='cart'><tr><th>Item code</th><th>Name of item</th><th>Description</th><th>Quantity</th><th>Price</th><th>Details</th></tr>";
                while($row=$result->fetch_assoc())
                {
                         ...
                         if($quantity>0)
                         {
                             echo "<tr><td>$itemcode </td><td>$itemname</td><td>$description</td> <td>$quantity</td> <td>$price</td><td><a href=itemdetails.php?icode=$itemcode&iprice=$price>Details</a></td></tr></table>";
                         }   
                         }   echo "</table";
            }
